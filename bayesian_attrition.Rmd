...
- The **specificity** of our posterior classifications reflects the overall proportion of employees who had not left the company that we correctly classified would not leave *(i.e., the proportion of $Y = 0$ outcomes that we correctly predicted to be 0)*. 
